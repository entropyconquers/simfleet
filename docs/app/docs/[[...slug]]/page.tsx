...
export default async function DocsPage({ params }: PageProps) {
  ...
  const sectionName = page.url.includes('/api-reference') ? 'API reference' : findSectionName(tree, page.url)
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  // One static social card; per-page images would need a server.
  const ogImageUrl = new URL(`${baseUrl}/og.png`)
